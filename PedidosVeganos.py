...
# "NOME_DO_PRATO" é o nome do prato, "EH_VEGADO?" indica se o prato é vegano (escrever "Vegano" ou "Nao-vegano"),
# e "YYY" é a quantidade de calorias do prato.
...
for i in range(1, numPedidos + 1):
    ...
    if i > 1:
        ...
        pedido = (f'Pedido {i}: {prato} ({vegano}) - {calorias} calorias')
